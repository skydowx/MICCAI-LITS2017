...
网络定义脚本 - Network definition script
"""
...
class ResUNet(nn.Module):
    ...
    def __init__(self, training):
        ...
        # Finally, the mapping under the large scale (256*256), the scales below are successively decreasing
