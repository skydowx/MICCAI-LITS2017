...
It takes about forty minutes, and the generated training data size is about 3G
"""

import os
import sys

# Appends empty string(sys.path[0]) at the end of sys.path
# There seems to be no point to this
# To guide the code editor environment maybe?
...
# Open-source multi-dimensional image analysis library
